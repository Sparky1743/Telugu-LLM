...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        # Find all divs with dir="ltr" and class="bbc-19j92fr ebmt73l0"
        divs = soup.find_all('div', dir='ltr', class_='bbc-19j92fr ebmt73l0')
        for div in divs:
            # Check if the div contains any Telugu text
            if is_telugu(div.text):
                extracted_data.append(div.text.strip())
    except Exception as e:
...
csv_folder_path = '/home/llmtelugu/csv_data/bbcnews'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/bbcnews'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/bbcnews/failed_urls.csv'
