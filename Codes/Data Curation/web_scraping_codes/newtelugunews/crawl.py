...
def crawl_data_from_link_with_retry(link, max_retries=3, retry_interval=5):
    ...
    headers = {
        ...
        'Accept-Language': 'te-IN,te;q=0.9',  # Telugu language preference
...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        # Find the div with the class 'mobilePadding'
        div = soup.find('div', class_='entry-content wp-block-post-content has-global-padding is-layout-constrained wp-block-post-content-is-layout-constrained')
        if div:
...
csv_folder_path = '/home/llmtelugu/csv_data/newtelugunews'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/newtelugunews'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/newtelugunews/failed_urls.csv'
