...
csv_folder_path = '/home/llmtelugu/data/telugu360_data/media/csvs'  # Update with your CSV folder path
# Directory to save the text files

corpus_directory = '/home/llmtelugu/data/telugu360_data/media/text'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/data/telugu360_data/media/failed_urls.csv'
