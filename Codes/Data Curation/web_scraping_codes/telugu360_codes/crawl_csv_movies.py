...
csv_folder_path = '/home/llmtelugu/data/telugu360_data/movies/csvs'  # Update with your CSV folder path
# Directory to save the text files

corpus_directory = '/home/llmtelugu/data/telugu360_data/movies/text'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/data/telugu360_data/movies/failed_urls.csv'
...
#             for video_link in p.find_all('a', href=True):
#                 if 'youtube' in video_link['href'] or 'vimeo' in video_link['href']:
#                     video_link.decompose()
