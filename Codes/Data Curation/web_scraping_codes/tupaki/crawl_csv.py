...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        # Find all divs with the specified classes
        div_classes = ['paira-h4 blockquote-style', 'about-section reviews']
...
csv_folder_path = '/home/llmtelugu/csv_data/news_xtra'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/tupaki'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/csv_data/tupaki/failed_urls.csv'
