...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        if main_div:
            ...
            print("Main content div with id 'block-system-main' not found.")
    except Exception as e:
...
csv_folder_path = '/home/llmtelugu/csv_data/andrabhoomi'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/andrabhoomi'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/csv_data/andrabhoomi_csv_completed/failed_urls.csv'
