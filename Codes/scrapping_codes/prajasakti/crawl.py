...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        # Find all divs with the class 'mg1-blog-post-box'
        divs = soup.find_all('div', class_='mg1-blog-post-box')
        for div in divs:
...
csv_folder_path = '/home/llmtelugu/csv_data/prajasakti'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/prajasakti'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/prajasakti/failed_urls.csv'
