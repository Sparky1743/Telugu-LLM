...
csv_folder_path = '/home/llmtelugu/csv_data/telugumopo'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/telugumopo'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/telugumopo/failed_urls.csv'
