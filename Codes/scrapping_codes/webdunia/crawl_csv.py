...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        p_elements = soup.find_all('div', style="text-align: justify;")
        for p in p_elements:
...
csv_folder_path = r'/home/llmtelugu/data/webdunia/csv'
corpus_directory = r'/home/llmtelugu/data/webdunia/text_data'
failed_csv_path = r'/home/llmtelugu/data/webdunia/Debug/failed_urls6.csv'
