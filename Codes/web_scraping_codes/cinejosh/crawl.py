...
csv_folder_path = '/home/llmtelugu/csv_data/cinejosh'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/cinejosh'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/cinejosh/failed_urls.csv'
