...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        tags = soup.find_all(['p', 'h3', 'div'], class_=['post-title entry-title', 'post-body entry-content'])
        for tag in tags:
            # Check if the tag contains any Telugu text
            if is_telugu(tag.text):
                extracted_data.append(tag.text.strip())
    except Exception as e:
...
csv_folder_path = '/Users/pavandeekshith/B-Tech/jwala/csv_data'  # Update with your CSV folder path
# Directory to save the text files
text_files_folder = '/Users/pavandeekshith/B-Tech/jwala/data'  # Update with your text data folder path
# Provide the path for the failed.csv file
failed_csv_path = '/Users/pavandeekshith/B-Tech/jwala/code/failed_urls.csv'
