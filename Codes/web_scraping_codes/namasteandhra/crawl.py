...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        if content_div:
            ...
            print("No div with class 'content-inner' found.")
    except Exception as e:
...
csv_folder_path = '/home/llmtelugu/csv_data/namasteandhra'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/namasteandhra'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/namasteandhra/failed_urls.csv'
