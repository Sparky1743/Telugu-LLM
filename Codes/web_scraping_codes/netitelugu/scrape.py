...
def extract_links(html_content):
    ...
    articles = soup.find_all('div', class_='jeg_block_container')
...
base_urls = {
    "AP-politics": "https://www.netitelugu.com/category/ap-politics/",
    "politics": "https://www.netitelugu.com/category/news/politics/",
    "entertainment": "https://www.netitelugu.com/category/entertainment/",

}

# Maximum pages for each category
max_pages_list = [108, 38, 5]

# Base directory to save CSV files
base_directory = '/home/llmtelugu/csv_data/netitelugu'
