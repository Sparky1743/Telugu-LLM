...
def extract_data_from_html(html_content):
    ...
    try:
        ...
        content_div = soup.find('div', class_='td_block_wrap tdb_single_content tdi_57 td-pb-border-top td_block_template_8 td-post-content tagdiv-type')
        if content_div:
...
csv_folder_path = '/home/llmtelugu/csv_data/telugubulletin'  # Update with your CSV folder path
# Directory to save the text files
corpus_directory = '/home/llmtelugu/data/telugubulletin'  # Update with your text data folder path

# Provide the path for the failed.csv file
failed_csv_path = '/home/llmtelugu/code/telugubulletin/failed_urls.csv'
