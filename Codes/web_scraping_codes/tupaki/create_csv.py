...
def extract_links(html_content, base_url):
    ...
    main_content_div = soup.find("div", class_="andhra-content andhra-district")
    if main_content_div:
        rows = main_content_div.find_all("div", class_="politics-flex")
        for row in rows:
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for future in as_completed(future_to_page):
            ...
            try:
                ...
                failed_urls.append(f"{base_url}/{page_num}")
...
corpus_dir = '/home/llmtelugu/csv_data/tupaki/entertainment'
num_pages = 16321
...
# andra pradesh - 473(Done)
# telangana - 287(Done)
# life style - 8(Done)
# sports - 63(Done)
# news - 15565
# entertainment - 16321
# movie-reviews - 198(Done)